...
XGBOOST_PARAMS = {
    ...
    "random_state": SEED,
    "n_jobs": -1,
    "tree_method": "hist",  # Atstājam hist
    "device": "cuda",
}
...
BATCH_TRAIN_FILES = [
    ...
    Path(r"stratificeta_atlase\merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct.csv"),
    Path(r"stratificeta_atlase\merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct.csv"),
    Path(r"stratificeta_atlase\merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct.csv"),
    Path(r"stratificeta_atlase\merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct.csv"),
    # 2. grupa — 10% pazīmes
    Path(r"stratificeta_atlase\10%\merged_no_nan_clean_headers_no_duplicates_train_grupa1_10pct.csv"),
    Path(r"stratificeta_atlase\10%\merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct_grupa1_10pct.csv"),
    Path(r"stratificeta_atlase\10%\merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct_grupa1_10pct.csv"),
    Path(r"stratificeta_atlase\10%\merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct_grupa1_10pct.csv"),
    Path(r"stratificeta_atlase\10%\merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct_grupa1_10pct.csv"),
    # 3. grupa — 50% pazīmes
    Path(r"stratificeta_atlase\50%\merged_no_nan_clean_headers_no_duplicates_train_grupa2_50pct.csv"),
    Path(r"stratificeta_atlase\50%\merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct_grupa2_50pct.csv"),
    Path(r"stratificeta_atlase\50%\merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct_grupa2_50pct.csv"),
    Path(r"stratificeta_atlase\50%\merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct_grupa2_50pct.csv"),
    Path(r"stratificeta_atlase\50%\merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct_grupa2_50pct.csv"),
]
