...
MODELS_DIR = Path(r"C:\Users\Edvins\source\repos\PythonApplication1\PythonApplication1\modeli_seed1")

# === BATCH TESTEŠANAS SARAKSTS: (modelis, testa_fails) ===
BATCH_EVAL_FILES = [
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_seed1.pkl",                               TEST_FULL),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct_seed1.pkl",              TEST_FULL),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct_seed1.pkl",              TEST_FULL),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct_seed1.pkl",              TEST_FULL),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct_seed1.pkl",              TEST_FULL),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_grupa1_10pct_seed1.pkl",                  TEST_10PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct_grupa1_10pct_seed1.pkl", TEST_10PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct_grupa1_10pct_seed1.pkl", TEST_10PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct_grupa1_10pct_seed1.pkl", TEST_10PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct_grupa1_10pct_seed1.pkl", TEST_10PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_grupa2_50pct_seed1.pkl",                  TEST_50PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_10pct_grupa2_50pct_seed1.pkl", TEST_50PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_25pct_grupa2_50pct_seed1.pkl", TEST_50PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_50pct_grupa2_50pct_seed1.pkl", TEST_50PCT),
    (MODELS_DIR / "merged_no_nan_clean_headers_no_duplicates_train_stratified_75pct_grupa2_50pct_seed1.pkl", TEST_50PCT),
]
